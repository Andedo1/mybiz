...
class _PaymentPageState extends State<PaymentPage> {
  ...
  void _redirect(String url) {
    ...
    if(_canRedirect) {
      ...
      if (_isSuccess) {
        //Get.offNamed(RoutesHelper.getOrderSuccessRoute(widget.orderModel.id.toString(), 'success'));
      } else if (_isFailed || _isCancel) {
        //Get.offNamed(RoutesHelper.getOrderSuccessRoute(widget.orderModel.id.toString(), 'fail'));
      }else{
